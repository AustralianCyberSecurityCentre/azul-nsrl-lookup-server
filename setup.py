...
setup(
    name="azul-nsrl-lookup-server",
    description="Self hosted service to lookup hashes from NSRL.",
    author="Azul",
    author_email="azul@asd.gov.au",
    url="https://www.asd.gov.au/",
    packages=["azul_nsrl_lookup_server"],
    include_package_data=True,
    python_requires=">=3.12",
    classifiers=[],
    entry_points={
        "console_scripts": [
            "azul-nsrl-lookup-server = azul_nsrl_lookup_server.cli:cli",
        ]
    },
